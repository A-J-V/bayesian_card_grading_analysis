# A Bayesian Analysis of Card Grade Stability
...
Fourth, due to the high cost and low speed of grading, each card was graded 3 times, which is only 2 regrades per card. We had 31 cards, so there were a total of 93 grades and 62 regrades, and this allows us to get a meaningful estimate. Nevertheless, it is still far from an ideal sampling situation, and it would have been preferable if each card could have gotten 4-6 regrades.
